...
public class ParticipantRegisteredHandler implements NotificationHandler {
    ...
    public NotificationEventType getHandledType() {
        return NotificationEventType.PARTICIPANT_REGISTERED;
    }
    ...
    public void handle(NotificationEvent event) {
        ...
        message.setSubject("Eventer - Etkinlik Kaydınız Onaylandı!");
        message.setText("""
                Merhaba,
                
                "%s" etkinliğine başarıyla kayıt oldunuz.
                
                📅 Tarih: %s
                📍 Şehir: %s
                
                Etkinlik öncesinde size hatırlatma maili gönderilecektir.
        ...
        log.info("[ParticipantRegistered] Kayıt onay maili gönderildi: {}", event.getRecipientEmail());
    }
}
